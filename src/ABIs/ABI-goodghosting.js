const ABI = [
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_segmentCount", type: "uint256" },
      { internalType: "uint256", name: "_segmentLength", type: "uint256" },
      { internalType: "uint256", name: "_segmentPayment", type: "uint256" },
  ...
  },
  {
    ...
    name: "FundsDepositedIntoExternalPool",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    inputs: [],
    name: "adaiToken",
    outputs: [{ internalType: "contract AToken", name: "", type: "address" }],
